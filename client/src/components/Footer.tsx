    ...
    <footer className="bg-slate-800 text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-slate-400">
              A modern React template for building exceptional web applications.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-slate-400">
              ...
              <li><Link href="/map" className="hover:text-white transition-colors duration-200">Map</Link></li>
              <li><Link href="/users" className="hover:text-white transition-colors duration-200">Users</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-slate-700 mt-8 pt-8 text-center text-slate-400">
          <p>&copy; 2024 ReactApp. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
